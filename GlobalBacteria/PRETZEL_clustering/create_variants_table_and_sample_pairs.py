...
raw_fasta_samples = sys.argv[1] # GB_BOTH_VOL_20260413_RENAMED_filtered.fa.gz
clustered_vars = sys.argv[2]    # GB_BOTH_VOL_20260413_RENAMED_filtered.fa.gz_scored_variants.fa.97.clustered.gz
