...
otu_file = "Selected_GBSEEDvariants_top_raw_abundance_in_samples_compress_nochloromito.txt"
reads_file = "reads_per_sample.tsv"
output_file = "OTU_relative_abundance_table_02_SEEDvariants.tsv"
...
with open(otu_file, "r") as fin, open(output_file, "w", newline="") as fout:
