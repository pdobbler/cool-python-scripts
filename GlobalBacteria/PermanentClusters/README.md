...
for file in *.fas
 do
  echo "blastn -query ${file} -db /mnt/DATA1/GLOBAL_BACTERIA/FINAL/SEEDS_97.0_WORKING_NAMES -out ${file%%.fas}_SEEDS97.txt -outfmt 6 -evalue 1E-5 -num_threads 2 -max_target_seqs 10"
