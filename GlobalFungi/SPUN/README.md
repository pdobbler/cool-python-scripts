...
```
mkdir FINAL
cat GF5_ALL_SAMPLES_AND_SPUN2_ITS2_minsize2_CLUSTERED.fa.gz GF5_ALL_SAMPLES_AND_SPUN2_ITS2_minsize2_CLUSTERED.fa.singletons.gz.binned.gz > GF5_ALL_SAMPLES_AND_SPUN2_ITS2_CLUSTERED_AND_BINNED.fa.gz
```

### MAKE OTU TABLE

`python2.7 GET_OTUTAB_FROM_SEQUENCES.py GF5_ALL_SAMPLES_AND_SPUN2_ITS2_CLUSTERED_AND_BINNED.fa.gz`

### GET SPUN SAMPLES

`zcat GF5_ALL_SAMPLES_AND_SPUN2_ITS2_CLUSTERED_AND_BINNED.fa.gz | awk '/^>GF/ {skip=1; next} /^>/ {skip=0} !skip' | gzip > SPUN2_ITS2_CLUSTERED_AND_BINNED.fa.gz`
