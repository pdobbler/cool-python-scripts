...
`python2.7 GET_VARINATS_FOR_ALL_TAXA_NEW.py GF5_RAW_TABLE_PROCESSED_UNITE10.txt.gz GF5_UNITE10_TAXONOMY_TABLE.txt.gz VARIANTS/ GF5_RAW_TABLE_SAMPLES.txt.gz`
