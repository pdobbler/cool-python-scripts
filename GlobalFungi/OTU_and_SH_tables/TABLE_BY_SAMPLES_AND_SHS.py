...
sample_pairing = sys.argv[2]    # GF5_RAW_TABLE_SAMPLES.txt.gz
sample_list = sys.argv[3]       # test_samples.txt OR -
shs_list = sys.argv[4]          # test_shs.txt OR -
...
i = 0
if sample_list == "-":
    for sid in sample_pairs:
        samples[sample_pairs[sid]] = i
        s_list.append(sample_pairs[sid])
        i += 1
else:
