...
python2.7 GET_TABLE_FROM_PROCESSEDBL_AND_VARSTAB.py GF5_RAW_TABLE_PROCESSED.txt.gz SSU_VARIANTS_kubik_temp2026_PROCESSED.txt SSU_VARIANTS_kubik_temp2026_ABUND_TABLE_sim98.5_cov95.txt 98.5 95.0 /mnt/DATA/projects/avetrot/AMF_DATABASE/FINAL_DATASETS/AMF_RELEASE1_CORRECTED/FULL_TABLES_FINAL/ALL_TABLES/AMF_TAB_SAMPLES.txt
```
