...
SSU
```
gunzip -c blastn -query - -db OMF_sequences.fa -outfmt 6 -evalue 1E-5 -num_threads 2 -max_target_seqs 10
/mnt/DATA/projects/avetrot/AMF_DATABASE/FINAL_DATASETS/AMF_RELEASE1_CORRECTED/FULL_TABLES_FINAL/SSU_VARIANTS.fa.gz
```
...
GF5 + SSU
```
python2.7 GET_TABLE_FROM_PROCESSEDBL_AND_VARSTAB.py /mnt/DATA1/RELEASE5/FOR_BLAST_UNITE9_COMPLETE/MAKE_TABLE_DIR/TOTALFINAL/GF5_RAW_TABLE_PROCESSED.txt.gz GF5_RAW_TABLE_PROCESSED_VARIANTS_kubik_temp2026_PROCESSED.txt GF5_RAW_TABLE_PROCESSED_VARIANTS_kubik_temp2026_ABUND_TABLE_sim98.5_cov95.txt 98.5 95.0 /mnt/DATA1/RELEASE5/FOR_BLAST_UNITE9_COMPLETE/MAKE_TABLE_DIR/TOTALFINAL/GF5_RAW_TABLE_SAMPLES.txt.gz

python2.7 GET_TABLE_FROM_PROCESSEDBL_AND_VARSTAB.py /mnt/DATA/projects/avetrot/AMF_DATABASE/FINAL_DATASETS/AMF_RELEASE1_CORRECTED/FULL_TABLES_FINAL/ALL_TABLES/AMF_TAB_PROCESSED.txt SSU_VARIANTS_kubik_temp2026_PROCESSED.txt SSU_VARIANTS_kubik_temp2026_ABUND_TABLE_sim98.5_cov95.txt 98.5 95.0 /mnt/DATA/projects/avetrot/AMF_DATABASE/FINAL_DATASETS/AMF_RELEASE1_CORRECTED/FULL_TABLES_FINAL/ALL_TABLES/AMF_TAB_SAMPLES.txt
```
